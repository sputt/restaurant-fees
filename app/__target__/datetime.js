...
export var dbm = 0;
for (var dim of __i__ (_DAYS_IN_MONTH.__getslice__ (1, null, 1))) {
...
export var _days_before_month = function (year, month) {
	return __k__ (_DAYS_BEFORE_MONTH, month) + (month > 2 && _is_leap (year));
};
...
export var date =  __class__ ('date', [object], {
	...
	get ctime () {return __get__ (this, function (self) {
		...
		return '{} {} {} 00:00:00 {}'.format (_DAYNAMES [weekday], __k__ (_MONTHNAMES, self._month), rjust (self._day, 2), zfill (self._year, 4));
	}, 'ctime');},
...
export var datetime =  __class__ ('datetime', [date], {
	...
	get ctime () {return __get__ (this, function (self) {
		var weekday = __mod__ (self.toordinal (), 7) || 7;
		return '{} {} {} {}:{}:{} {}'.format (__k__ (_DAYNAMES, weekday), __k__ (_MONTHNAMES, self._month), zfill (self._day, 2), zfill (self._hour, 2), zfill (self._minute, 2), zfill (self._second, 2), zfill (self._year, 4));
	}, 'ctime');},
